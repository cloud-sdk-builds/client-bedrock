...
[`@aws-sdk/client-bedrock`](https://www.npmjs.com/package/@aws-sdk/client-bedrock/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eZzr5CTMbjlDup64ssgM+1jwFxetWC45lHrzHfUo5YWIS1yMo0ybt7szBhCtTAbz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-bedrock": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock@3.933.0/index.min.mjs": "sha384-eZzr5CTMbjlDup64ssgM+1jwFxetWC45lHrzHfUo5YWIS1yMo0ybt7szBhCtTAbz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-bedrock/blob/refs/tags/3.933.0/LICENSE
```
